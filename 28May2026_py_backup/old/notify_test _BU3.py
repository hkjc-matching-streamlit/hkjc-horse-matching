...
real_not_arranged_list = [
    "真馬名4",
    "真馬名5",
]

running_list = real_running_list
standby_list = real_standby_list
not_arranged_list = real_not_arranged_list
